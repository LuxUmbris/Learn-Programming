Hier ist deine korrigierte Version. Ich habe mich strikt an deinen Wortlaut und Stil gehalten und lediglich die Rechtschreib-, Grammatik- und Tippfehler korrigiert. Der Text endet, wie gewünscht, nach dem Kapitel zur Systemprogrammierung.
...
1. [Grundlagen des Programmierens](https://www.google.com/search?q=%23grundlagen-des-programmierens) 
1.1 [Variablen](https://www.google.com/search?q=%23variablen) 
1.2 [Datentypen](https://www.google.com/search?q=%23datentypen) 
1.3 [Funktionen](https://www.google.com/search?q=%23funktionen) 
1.4 [Kommentare](https://www.google.com/search?q=%23kommentare)
2. [Einführung in Python](https://www.google.com/search?q=%23python) 
2.1 [Blöcke (Scopes)](https://www.google.com/search?q=%23bl%C3%B6cke-scopes) 
2.2 [Variablen in Python](https://www.google.com/search?q=%23variablen-in-python) 
2.3 [Funktionen in Python](https://www.google.com/search?q=%23funktionen-in-python) 
2.4 [Die Standardbibliothek](https://www.google.com/search?q=%23die-standardbibliothek) 
2.5 [Bedingungen und Kontrollfluss](https://www.google.com/search?q=%23bedingungen-und-kontrollfluss) 
2.6 [Strings in Python](https://www.google.com/search?q=%23strings-in-python)
3. [Andere Programmiersprachen](https://www.google.com/search?q=%23andere-programmiersprachen)
4. [Einstieg in die Systemprogrammierung](https://www.google.com/search?q=%23einstieg-in-die-systemprogrammierung)
...
> **Wichtig:** Voraussetzung für diesen Abschnitt ist, dass du weißt, was ein Terminal oder eine Konsole ist, oder Abschnitt 7.1 [Die Konsole](https://www.google.com/search?q=%23die-konsole) gelesen hast.
...
# bis der Nutzer schreibt und Enter drückt. Die Eingabe wird dann zurückgegeben.
...
Wenn du eine Variable definierst, verbrauchst du damit physischen Platz auf deiner CPU (Zentralen Recheneinheit) oder im RAM (Arbeitsspeicher). In Hochsprachen wie Python wird dafür oft ein sogenannter GC (Garbage-Collector/"Müllsammler") genutzt. Dieser pausiert die komplette Ausführung des Programms und gibt ungenutzten Platz wieder frei. Dies kostet aber wie beschrieben wertvolle Ausführungszeit. Deswegen gibt es Sprachen mit manueller Speicherverwaltung. Dies ist allerdings extrem fehleranfällig. Wieder andere Sprachen geben Variablen immer am Ende von Scopes frei.
